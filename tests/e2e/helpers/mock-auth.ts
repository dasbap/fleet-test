...
/** Aligné sur `DEFAULT_E2E_MOCK_ORG_ID` côté app (`src/lib/e2e-onboarding.ts`). */
...
/** Session mock auth + fallback démo (compatible `MockAuthProvider`). */
...
/** Réduit le bruit réseau Supabase pendant les scénarios E2E. */
