...
export function getSupabaseEnv(): SupabaseEnv {
  return {
    ...
    appUrl: process.env.VITE_APP_URL ?? process.env.APP_URL ?? "https://www.e-samba.com",
  };
}
...
export async function requireAuthenticatedUser(
  req: VercelRequest,
  res: VercelResponse,
): Promise<{ env: SupabaseEnv; user: User; client: SupabaseClient } | null> {
