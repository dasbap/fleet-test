    ...
    ln: [
      {
        ...
        answer:
          'E-Samba ezali na formules misato : Starter (tii na biloko 5), Standard (tii na biloko 20) mpe Pro (biloko oyo ezali koleka). Formule nyonso ezali na essai ya mikolo 7 ofele.',
