...
export class DemoRequestService {
  ...
  async submitRequest(input: SubmitDemoRequestInput): Promise<void> {
    ...
    const verificationAccessToken = input.emailVerificationToken.trim();
    ...
    if (!verificationAccessToken) throw new Error("Vérifiez votre adresse e-mail avec le code E-Samba avant d'envoyer la demande.");
