...
export function WhatsAppButton() {
  const number = import.meta.env.VITE_WHATSAPP_NUMBER || "237600000000";
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe5d] transition-colors group"
    >
