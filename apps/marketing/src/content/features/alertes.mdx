...
description: "Push, email et SMS sur seuils critiques."
pubDate: 2026-05-20
draft: false
module: "Alertes"
---
...
Ce guide présente les bonnes pratiques autour de **Alertes intelligentes** pour les gestionnaires de flotte en Afrique centrale.
