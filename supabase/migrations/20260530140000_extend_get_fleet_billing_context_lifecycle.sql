-- Étend get_fleet_billing_context pour la page /dashboard/billing :
-- lifecycle abonnement (trial, grace, suspended), dates, slots véhicules, flags plan complets.
...
COMMENT ON FUNCTION public.get_fleet_billing_context(uuid) IS
  'Contexte facturation flotte : lifecycle abonnement, slots véhicules, flags plan (page billing + gardes UI).';
