-- get_fleet_billing_context : auth + rôles, puis délégation à get_fleet_billing_context_internal.
...
COMMENT ON FUNCTION public.get_fleet_billing_context(uuid) IS
  'Contexte billing frontend : auth + rôles flotte, puis get_fleet_billing_context_internal + lifecycle plan.';
