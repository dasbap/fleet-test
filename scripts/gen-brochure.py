...
def draw_page(c):
    ...
    plans = [
        ...
        },
        {
            ...
            "features": ["Jusqu'à 5 véhicules", "Samba-Fleet complet", "Samba-Cash essentiel", "Support e-mail"],
        ...
        },
        {
            ...
            "price": "21 000 FCFA",
            "period": "/ véhicule / mois",
            "features": ["Jusqu'à 25 véhicules", "Suite complète Samba", "Coaching · Dashcam IA", "Alertes push/SMS · prioritaire"],
            "color": GREEN,
            "popular": True,
        },
        {
